...
func builtinNowDateTime(ctx EvalContext) (interface{}, error) {
	return time.Now().Format(time.DateTime), nil
}

func builtinNowTime(ctx EvalContext) (interface{}, error) {
	return time.Now().Format(time.TimeOnly), nil
}

func builtinNowDate(ctx EvalContext) (interface{}, error) {
	return time.Now().Format(time.DateOnly), nil
}

func builtinNow(ctx EvalContext) (interface{}, error) {
