...
var defaultDipper = New(Options{Separator: SEPARATOR, Slice: SLICE, Wildcard: WILDCARD})
...
//	    return err
//	}
func Get(obj any, attribute string) any {
	return defaultDipper.Get(obj, attribute)
}

func FilterSlice(obj any, field string, value []any) any {
...
//	    return err
//	}
func GetMany(obj any, attributes []string) Fields {
