...
func ContainsStr(str string, search string) bool {
...
// TrimSpace removes control characters from both ends of this string.
...
// DefaultString Returns either the passed in String, or if the String is Empty, the value of defaultStr.
