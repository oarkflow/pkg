...
var (
	ExchangeRateURL = "https://api.exchangerate.host"
...
func Convert(amount decimal.Decimal, baseCurrency string, targetCurrency string) decimal.Decimal {
...
func (c *CurrencyRate) Convert(amount decimal.Decimal) decimal.Decimal {
...
func (c *CurrencyRate) cache(date string) {
	...
	c.Store.Set(key, val, 24*time.Hour)
}
