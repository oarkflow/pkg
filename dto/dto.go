...
var (
	nilRecvRfType   = reflect.TypeOf(nilRecvT{})
	errorRfType     = reflect.TypeOf((*error)(nil)).Elem()
	mapperPtrRfType = reflect.TypeOf((*Mapper)(nil))
)

type (
	convertFuncClosure = func(reflect.Value, *Mapper) (reflect.Value, error)
	inspectFuncClosure = func(reflect.Value, reflect.Value, *Mapper) error
)
